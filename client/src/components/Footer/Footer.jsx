...
const Footer = () => {
  ...
  return (
    <div className="bg-black text-[#949494] pt-10 border-t-[1px] border-white">
      <div className="container flex flex-col md:flex-row justify-between gap-4 items-center px-4">
        <div className="flex gap-4 flex-col items-center">
          <Link to="/" className="logo">
            <img className="w-32 rounded-[40px]" src={logoStore} alt="logoStore" />
          </Link>
          <div className="flex flex-col items-center gap-4">
            <img className="w-56" src={paymentLogo} alt="paymentLogo" />
            <div className="flex gap-5 text-lg text-gray-400">{renderSocial}</div>
          </div>
        </div>
        <div className="flex flex-wrap justify-center gap-10 py-4">
          <div className="w-[200px]">
            <h2 className="text-xl font-semibold text-white mb-4 uppercase">locate us</h2>
            <div className="text-base flex flex-col gap-2" id="contacts">
              ...
              <a href="mailto:shop@gmail.com&body=Hello?subject=question">e-mail: shop@gmail.com</a>
            </div>
          </div>
          <div className="w-[200px]">
            <h2 className="text-xl font-semibold text-white mb-4 uppercase">profile</h2>
