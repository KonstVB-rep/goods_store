...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      tabIndex="0"
      className="image-box w-full relative group rounded-md overflow-hidden flex flex-col border-[1px] border-gray-300"
    >
      <div
        role="link"
      ...
      <div className="w-full py-4 grow flex flex-col border-t-[1px] border-gray-300 gap-2 bg-gray-300">
